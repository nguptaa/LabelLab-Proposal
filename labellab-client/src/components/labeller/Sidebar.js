...
export default class Sidebar extends PureComponent {
  render() {
    ...
    const modelOptions = [
      { key: 'frcnn', value: 'frcnn', text: 'Faster-RCNN' },
      { key: 'yolo', value: 'yolo', text: 'YOLO' },
      { key: 'segmen', value: 'segmen', text: 'Semantic Segmentation' }
    ]
    ...
    return (
      ...
      >
        ...
        <Header size="tiny" style={{ flex: '0 0 auto' }}>
          {'Generate bounding box using a ML model'}
        </Header>
        <Select placeholder="Select a model" options={modelOptions} />
        <br></br>
